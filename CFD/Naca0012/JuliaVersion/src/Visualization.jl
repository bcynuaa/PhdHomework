...
const xlim::Vector{Float64} = [-1.5, 2.5]; # default xlim
const ylim::Vector{Float64} = [-2, 2]; # default ylim
const delta::Float64 = 0.1; # default delta value of colorbar
const cmap::String = "jet"; # default cmap
const color_layer::Int64 = 15; # default cmap layer number
const edge_color::String = "k"; # default contour line color
const lw::Float64 = 1.; # default contour line width
